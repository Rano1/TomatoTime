...
public class PullToRefreshView extends LinearLayout {
	...
	private RotateAnimation mFlipAnimation_down;
	/**
	 * 变为逆向的箭头,旋转
	 */
	...
	private void init() {
		...
		mFlipAnimation_down = new RotateAnimation(-180, 0,
				RotateAnimation.RELATIVE_TO_SELF, 0.5f,
				RotateAnimation.RELATIVE_TO_SELF, 0.5f);
		mFlipAnimation_down.setInterpolator(new LinearInterpolator());
		mFlipAnimation_down.setDuration(250);
		mFlipAnimation_down.setFillAfter(true);
...
//		addView(mHeaderView, params);
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_DOWN:
			// 首先拦截down事件,记录y坐标
			// Log.e("onInterceptTouchEvent", "down"+y);
			mLastMotionY = y;
			break;
		case MotionEvent.ACTION_MOVE:
			// deltaY > 0 是向下运动,< 0是向上运动
			int deltaY = y - mLastMotionY;
			// Log.e("onInterceptTouchEvent", "move"+deltaY);
...
//				}
	 ...
	 *            ,手指滑动的距离
	 */
	public boolean refresh_pd = false;
...
//			if (refresh_pd) {
//				mHeaderImageView.clearAnimation();
//				mHeaderImageView.startAnimation(mFlipAnimation_down);
//				refresh_pd = false;
//			}
//			// mHeaderImageView.
...
//		mHeaderImageView.setImageResource(R.drawable.listview_arrow);
//		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
//		mHeaderProgressBar.setVisibility(View.GONE);
//		SimpleDateFormat sDateFormat = new SimpleDateFormat(
//				"yyyy-MM-dd hh:mm:ss");
//		String date = sDateFormat.format(new java.util.Date());
//		mHeaderUpdateTextView.setText(date);
//		mHeaderState = PULL_TO_REFRESH;
//	}
